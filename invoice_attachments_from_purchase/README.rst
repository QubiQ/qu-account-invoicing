=================================
Invoice Attachments From Purchase
=================================

Copies attachments from purchase order to invoice.


Usage
=====

Create an invoice from a purchase order. The attachments will be copied.
